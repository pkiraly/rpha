...
%><bean:define id="id" name="newBookForm" property="id" 
...
<bean:write name="newBookForm" property="id" filter="false" />
  </script>
  <link rel="stylesheet" type="text/css" href="<%=PATH%>/css/form.css" />
</head>
<body>

<p><!-- a href="<%=PATH%>/id/poem">[vissza a vershez]</a --></p>
<!-- bean:write name="newBookForm" property="xml" /-->
